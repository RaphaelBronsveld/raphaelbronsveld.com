...
meta:
  ...
  - ogtitle:
    property: og:title
    content: Preloaded fonts loading twice - Raphaël Bronsveld
  - ogurl:
    property: og:url
    content: https://www.raphaelbronsveld.com/blog/preloading-fonts
  - ogdescription:
    property: og:description
    content: Ever dealt with preloading fonts and noticed they loaded twice? Here's why.
  - ogimage:
    property: og:image
    content: https://www.raphaelbronsveld.com/blog/preload-typography.webp
---
